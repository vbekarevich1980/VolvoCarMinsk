...
from volvocarminskapp.View.CarTab.components.CarMainScreen.car_main_screen import CarMainScreenView


class CarMainScreenController:
    """
    ...
    def __init__(self, model):
        ...
        self.view = CarMainScreenView(controller=self, model=self.model)
    ...
    def get_view(self) -> CarMainScreenView:
        return self.view
